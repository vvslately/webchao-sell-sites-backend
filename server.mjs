...
// Middleware
app.use(cors({
  origin: ['http://localhost:5173', 'https://vhousespace.vercel.app'  , 'http://localhost:5174', 'http://localhost:3000', 'https://vhouse.space', 'https://web-rental-frontend.vercel.app', 'https://www.vhouse.space', 'https://wichx-seller-sites-frontend.vercel.app'],
  credentials: true,

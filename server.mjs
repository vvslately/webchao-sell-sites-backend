      ...
      if (existingSites.length === 0) {
        try {
          ...
          const [categoryResult] = await connection.execute(
            ...
            [customerId.toString(), `${website_name} Category`, `Category for ${website_name}`, `https://img5.pic.in.th/file/secure-sv1/1640x500.jpg`, `${website_name.toLowerCase()}_category`, 0, 1, 0]
          );
